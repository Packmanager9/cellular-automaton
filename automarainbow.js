...
class Rectangle {
    ...
    draw() {
        ...
        if (this.pile == 0) {
            ...
            tutorial_canvas_context.fillStyle = "#00ff00"
        }else if (this.pile == 4) {
            tutorial_canvas_context.fillStyle = "green"
        }else if (this.pile == 5) {
            tutorial_canvas_context.fillStyle = "blue"
        }else if (this.pile == 6) {
            tutorial_canvas_context.fillStyle = "cyan"
        }else if (this.pile == 7) {
            tutorial_canvas_context.fillStyle = "purple"
        }else if (this.pile == 8) {
...
class Grid {
    constructor() {
        this.blocks = []
        // this.dirs = []
        for (let t = 0; t < tutorial_canvas.width; t += 5) {
            this.holdblocks = []
            for (let k = 0; k < tutorial_canvas.height; k += 5) {
                const rect = new Rectangle(k, t, 5, 5)
...
rectx.blocks[70][70].pile+= 9
rectx.blocks[71][70].pile+= 9
rectx.blocks[70][71].pile+= 9
rectx.blocks[70][69].pile+= 9
